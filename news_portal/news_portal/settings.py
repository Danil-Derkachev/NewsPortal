...
INSTALLED_APPS = [
    ...
    # Добавляются только на версии django-allauth 0.61.1
...
DATABASES = {
    'default': {
        #'ENGINE': 'django.db.backends.sqlite3',  # Для работы с БД sqlite
        #'NAME': BASE_DIR / 'db.sqlite3',
        'ENGINE': 'django.db.backends.postgresql',  # Для работы с БД postgresql
        'NAME': 'postgres',
        'USER': 'postgres',
        'PASSWORD': 'admin',
        'HOST': 'localhost',
